...
CPU 이름에는 DS918+의 CPU인 J3455가,<br>
CPU 클럭 속도와 코어 정보 역시 J3455의 값이 표시되고 있습니다.
...
Linux의 Terminal이나 Windows의 PuTTY를 이용해 XPEnology에 접속합니다.

<center>
<img src="/images/PostImages/201224 XPEnology CPU Info Change/3_terminal_1.png" style="width: 75%;">
</center>

접속이 완료되었다면, 다음 명령어를 통해 root로 로그인한 뒤,<br>
...
1을 눌러주면 두번째 사진과 같은 메뉴로 이동합니다.<br>
간편하게 자동으로 CPU 정보가 입력되도록 y를 입력하면<br>
눈 깜짝할 사이에 작업이 완료됩니다.
