...
zsh의 설치가 완료되었다면,<br>
다음 명령어를 통해 사용자의 기본 쉘을 zsh로 변경해줍니다.<br>
...
zsh로 진입되었다면, 이제 다음 명령어를 통해 oh my zsh 플러그인을 설치해줍니다.

oh my zsh는 zsh를 쉽고 간편하게 커스터마이징할 수 있도록 돕는<br>
오픈소스 플러그인입니다.<br>
...
아래 명령어로 curl을 설치하신 뒤 oh my zsh를 설치하시면 됩니다.
...
로그인된 사용자의 홈 디렉토리에서 .zshrc파일을 텍스트 에디터로 열어,<br>
...
bash보다 훨씬 기능과 플러그인이 많고,<br>
커스터마이징이 가능한 zsh의 설치에 대해 알아보았습니다.
